...
@RestController
@RequestMapping("/api/app-kaazar-kafka")
public class AppKaazarKafkaResource {
    private final Logger log = LoggerFactory.getLogger(AppKaazarKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AppKaazarKafkaResource(KafkaProperties kafkaProperties) {
