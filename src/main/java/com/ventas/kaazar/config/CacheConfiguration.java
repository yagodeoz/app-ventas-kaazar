package com.ventas.kaazar.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ventas.kaazar.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ventas.kaazar.repository.UserRepository.USERS_BY_EMAIL_CACHE);
